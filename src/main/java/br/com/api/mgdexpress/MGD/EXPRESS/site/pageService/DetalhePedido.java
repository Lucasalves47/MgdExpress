                      ...
                      <head>
                          ...
                          <style>
                              ...
                              @media only screen and (max-width: 600px) {
                                  h2 {
                                      margin-left: 20px; /* Ajusta a margem esquerda do título */
                                  }
                      
                                  .card {
                                      padding: 15px; /* Reduz o preenchimento interno da carta */
                                  }
                              }
                      
                              @media only screen and (max-width: 400px) {
                                  h2 {
                                      margin-left: 10px; /* Ajusta a margem esquerda do título */
                                  }
                              }
                          </style>
                      </head>

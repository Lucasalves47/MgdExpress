                ...
                <head>
                                                        ...
                                                        <nav>
                                                            ...
                                                            <div>
                                                                ...
                                                                <button onclick="abripopUpPedidoEmBranco()">Criar Pedido em Branco</button>
                                                            </div>
                                                        </nav>
                                                        ...
                                                        <main id="main">
                                                            ...
                                                            <div id="popUpPedidoEmBranco">
                                                                <h2>Comanda</h2>
                                                              
                                                                <input type="text" id="inputPedidoEmBranco">
                                                                <button onclick="criar()">Criar</button>
                                                                <button onclick="fecharPopUpFora()">Cancelar</button>
                                                            </div>
                                                        </main>
                                                        ...
                                                        <script>
                                                            ...
                                                            function criar() {
                                                                ...
                                                                var comanda = document.getElementById("inputPedidoEmBranco").value
                                                                criarPedidoSemDados(comanda);
                                                                console.log(comanda)
                                                            }
                                                        
                                                            function abripopUpPedidoEmBranco() {
                                                                document.getElementById("main").style.backgroundColor = "#dddddd"
                                                                document.getElementById("popUpPedidoEmBranco").style.display = "block"
                                                            }
                                                        
                                                            function fecharPopUpFora() {
                                                                var popUp = document.getElementById('popUpPedidoEmBranco').style.display = 'none';
                                                        ...
                                                        <script>
                                                            ...
                                                            var status = setInterval(status, 27000)
                                                        </script>

    ...
    public static String formulario(){
        return  """
                ...
                <body>
                    ...
                    <button style="background-color: #808080;margin-top: 28px;"  type="button" onclick="carregarPagina("https://mgdexpress-production.up.railway.app/site/gerente/home")">Cancelar</button>
                </body>
                </html>
